...
public class MessagesController : ControllerBase
{
    ...
    [HttpGet("api/v1/consults/{id}/[controller]")]
    public async Task<IEnumerable<MessageResource>> GetAllConsultIdAsync(int consultId)
    {
        var messages = await _messageService.ListByPersonIdAsync(consultId);
        var resources = _mapper.Map<IEnumerable<Message>, IEnumerable<MessageResource>>(messages);
        return resources;
    }
}